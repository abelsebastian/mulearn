...
const levelsData = [
    ...
    cards: [
      {
        ...
        icon: <MdVideoLibrary />,  // or use another preferred icon for Discord onboarding
      ...
      },
      {
        ...
        icon: <MdDesignServices />,  // or another icon that represents self-intro or community
  ...
  },
  {
    ...
    leveller: {
      ...
      ig: "Python Course",
      icon: <MdVideoLibrary />, // Replace with a relevant icon
    ...
    cards: [
      ...
      },
      {
        ...
        icon: <MdDesignServices />, // Replace with a relevant icon
      ...
      },
      {
        ...
        resources: ["https://ginger-marble-4c3.notion.site/DWMS-MuID-Connect-5a529107cdce4f9c982abc65b4e50702"]
      }
    ]
  },
  {
